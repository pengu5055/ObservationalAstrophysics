...
source_id, ra, dec, parallax, pmra, pmdec, phot_g_mean_mag = \
    np.column_stack(np.genfromtxt("SMC_rangemag_alt.csv", delimiter=",", skip_header=1))
...
x_coord = 0.75
y_coord = -1.26
filt = ellipse(pmra, pmdec, x_coord, y_coord, 0.4, 0.25)
