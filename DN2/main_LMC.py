...
source_id, ra, dec, parallax, pmra, pmdec, phot_g_mean_mag = np.column_stack(np.genfromtxt("LMC_tc_nomag.csv", delimiter=",", skip_header=1))
source_id2, ra2, dec2, parallax2, pmra2, pmdec2, phot_g_mean_mag2 = np.column_stack(np.genfromtxt("LMC_tc_rangemag5.csv", delimiter=",", skip_header=1))

plt.title("LMC in the field")
