...
# Additional curves
data_8 = sun_analemma(GMST, 120, AGO_lambda, AGO_phi)
data_9 = sun_analemma(GMST, 135, AGO_lambda, AGO_phi)
data_10 = sun_analemma(GMST, 150, AGO_lambda, AGO_phi)
data_12 = sun_analemma(GMST, 180, AGO_lambda, AGO_phi)
data_13 = sun_analemma(GMST, 195, AGO_lambda, AGO_phi)
data_14 = sun_analemma(GMST, 210, AGO_lambda, AGO_phi)
data_15 = sun_analemma(GMST, 225, AGO_lambda, AGO_phi)
data_16 = sun_analemma(GMST, 240, AGO_lambda, AGO_phi)
